...
public class ProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Product> movies = new ArrayList<>();
    ...
    public void setMoviesData(List<Product> movies) {
        this.movies.clear();
    ...
    public class ProductViewHolder extends Holder {
        ...
        public void bind(String posterUrl, String releaseDate, String price) {
        ...
        public void setItemClickListener(final OnClickListener onClickListener, final Product movie) {
...
//              d.dismiss(); // dismiss the dialog
    ...
    public interface OnClickListener {
        void onItemClickListener(String id, Product movie);
    }
