...
public class DetilProductActivity extends AppCompatActivity {
    ...
    @BindView(R.id.btn_detail_purchase)Button btnMarkFav;
    @BindView(R.id.btn_beli)Button btnBeli;
    @BindView(R.id.txt_price)TextView txtPrice;

    public static String iName, iPic, iCat, cid, itemId, iPrice, au;
    ...
    private void getData(){
        ...
        iPrice = i.getStringExtra("iprice");
    }

    @OnClick(R.id.btn_beli)
    public void buy(View view) {
        final Dialog d = new Dialog(DetilProductActivity.this);
...
//              d.dismiss(); // dismiss the dialog
        ...
        bSubmitQuantity.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if(qtyTemp > 0){
                    ...
                    AlertDialog alertDialog = new AlertDialog.Builder(DetilProductActivity.this).create();
    ...
    public void markFavorite(View view) {
        markFavorite(cid, itemId);
    }

    private void markFavorite(String uid, String iid) {

        final ProgressDialog dialog = ProgressDialog.show(this, "", "Mark As Favorite...");

        ApiService apiService =
                RestApi.getClient().create(ApiService.class);

        Call<MarkFavoriteResponse> call = apiService.markAsFavorite(uid, iid);
        call.enqueue(new Callback<MarkFavoriteResponse>() {
            @Override
            public void onResponse(Call<MarkFavoriteResponse>call, Response<MarkFavoriteResponse> response) {
                dialog.dismiss();
            ...
            @Override
            public void onFailure(Call<MarkFavoriteResponse>call, Throwable t) {
                dialog.dismiss();
    ...
    private void saveItemToDB(String cid, String iid, String iName, int iPrice, String iQty,
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DetilProductActivity.this, CartActivity.class));
                finish();
            }
        });
